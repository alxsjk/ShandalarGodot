...
Development source: `main`, version **0.40.1**. A desktop LAN full-pool duel
...
Use matching **0.40.1 development builds** and enabled packs on both computers. The older
