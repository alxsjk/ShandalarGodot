...
Development implementation on `main`, **0.40.2** (protocol **21**). Internet play, permanent accounts,
...
build fingerprint. Use matching 0.40.2 builds and enabled packs for recovery.
...
1. Use matching 0.40.2 builds (protocol 21) and enabled card packs. Open the globe, choose a
