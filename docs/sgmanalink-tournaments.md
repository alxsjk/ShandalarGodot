...
Development implementation on `main`, **0.40.0** (protocol **20**). Internet play, permanent accounts,
...
build fingerprint. Use matching 0.40.0 builds and enabled packs for recovery.
