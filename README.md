...
run the source with Godot 4.7 (below): `main` carries **0.40.1**, the next
...
Latest local verification ([Lettering on the stone](docs/ROADMAP.md#2026-09-18--lettering-on-the-stone-0401)):
**7,544 GUT tests / 334,159 assertions**, plus **291 Python tests**
