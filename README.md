...
run the source with Godot 4.7 (below): `main` carries **0.40.2**, the next
...
Latest local verification ([Hover text that fits the window](docs/ROADMAP.md#2026-09-18--hover-text-that-fits-the-window-0402)):
**7,549 GUT tests / 334,302 assertions**, plus **291 Python tests**
